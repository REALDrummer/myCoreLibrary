...
public class WikiUtilities {
    ...
    public static Boolean isLiquid(Block block) {
        return isLiquid(block.getTypeId());
    }

    public static Boolean isLiquid(String block_name) {
        Integer[] id_and_data = getItemIdAndData(block_name, false);
        if (id_and_data == null)
            return null;

        return isLiquid(id_and_data[0]);
    }
    ...
    public static Boolean isNonSolid(Block block) {
        return isNonSolid(block.getTypeId());
    }

    public static Boolean isNonSolid(String block_name) {
        Integer[] id_and_data = getItemIdAndData(block_name, false);
        if (id_and_data == null)
            return null;

        return isNonSolid(id_and_data[0]);
    }
    ...
    public static Boolean isSolid(int id) {
        ...
        return !isLiquid(id) && !isNonSolid(id);
    }
    ...
    public static Boolean isSolid(String block_name) {
        Integer[] id_and_data = getItemIdAndData(block_name, false);
        if (id_and_data == null)
            return null;
        return isSolid(id_and_data[0]);
    }
